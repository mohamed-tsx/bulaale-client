...
{t('profile.cancel')}
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">{t('profile.noOrdersYet')}</h3>
                  <p className="text-gray-600 mb-4">{t('profile.noOrdersYetDescription')}</p>
                  <Button asChild>
                    <a href="/products">{t('profile.startShopping')}</a>
                  </Button>
                </div>
              )}
            </CardContent>
